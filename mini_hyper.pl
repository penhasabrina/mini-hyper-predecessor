...
not(_,_,_).
% =========================================================
% PROBLEMA: aprender predecessor/2
% =========================================================

% Base de conhecimento da familia
...
% Hipotese inicial
% O livro sugere iniciar com duas clausulas
